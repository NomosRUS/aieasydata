...
Создан автоматически: 2025-09-28T03:04:09.215754
Пайплайн: test_module1_validation
"""
...
tasks['validate_small_file'] = PythonOperator(
    task_id='validate_small_file',
    python_callable=execute_function_call,
    op_kwargs={
        'function': 'validate_file_direct',
        'endpoint': '/api/v1/data-quality/validate-file',
        'method': 'POST',
        'parameters': {"file_path": "/data/raw/test_small.csv", "validation_options": {"assess_quality": True, "check_duplicates": True, "detect_anomalies": True}}
    },
    retries=1,
