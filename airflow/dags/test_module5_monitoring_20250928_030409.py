...
Создан автоматически: 2025-09-28T03:04:09.220327
Пайплайн: test_module5_monitoring
"""
...
tasks['auto_detect_small_file'] = PythonOperator(
    task_id='auto_detect_small_file',
    python_callable=execute_function_call,
    op_kwargs={
        'function': 'auto_detect_source',
        'endpoint': '/api/v1/metrics/auto-detect',
        'method': 'GET',
        'parameters': {"source": "/data/raw/test_small.csv"}
    },
    retries=1,
