...
# Множественные рекомендации для расширенного тестирования
recommendations = [
...
try:
    ...
    with psycopg2.connect(**db_params) as conn:
        with conn.cursor() as cur:
            print("Inserting/updating extended test recommendations...")
            ...
            conn.commit()
            print(f"[SUCCESS] {len(recommendations)} optimization recommendations inserted for extended dataset.")
